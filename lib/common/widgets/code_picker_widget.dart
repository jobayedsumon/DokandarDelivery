...
class _CodePickerWidgetState extends State<CodePickerWidget> {
  ...
  void didUpdateWidget(CodePickerWidget oldWidget) {
    ...
    if (oldWidget.initialSelection != widget.initialSelection) {
      if (widget.initialSelection != null) {
        selectedItem = elements!.firstWhere((e) => (e.code!.toUpperCase() == widget.initialSelection!.toUpperCase()) || (e.dialCode == widget.initialSelection)
          || (e.name!.toUpperCase() == widget.initialSelection!.toUpperCase()), orElse: () => elements![0]);
      } else {
  ...
  void initState() {
    ...
    favoriteElements = elements!.where((e) => widget.favorite!.firstWhereOrNull((f) =>
    e.code!.toUpperCase() == f.toUpperCase() || e.dialCode == f || e.name!.toUpperCase() == f.toUpperCase()) != null).toList();
    }
  }
          ...
          child: Container(
            ...
            child: Dialog(
              child: SelectionDialog(
                ...
                headerTextStyle: const TextStyle(inherit: true),
                topBarPadding: const EdgeInsets.only(top: 10, left: 10, right: 10),
              ),
            ),
          ),
        ),
            ...
            if (widget.showFlagMain != null ? widget.showFlagMain! : widget.showFlag!)
              Flexible(
                ...
                child: Container(
                  ...
                  margin: widget.alignLeft! ? const EdgeInsets.only(right: 0.0, left: 0) : const EdgeInsets.only(right: 0.0, left: 0),
                  child: Image.asset(
