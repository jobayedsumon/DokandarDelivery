...
import 'package:delivery_delivery/helper/custom_validator_helper.dart';
...
import 'package:delivery_delivery/features/auth/widgets/condition_check_box_widget.dart';
                  ...
                  onPressed:  !authController.acceptTerms ? null : () async {
                    if(authController.dmStatus == 0.4){
                      ...
                      try {
                        ...
                        numberWithCountryCode = phoneNumber.international;
                        isValid = phoneNumber.isValid();
                      } catch (e) {
                        debugPrint('Number is not valid ${e.toString()}');
                      }
